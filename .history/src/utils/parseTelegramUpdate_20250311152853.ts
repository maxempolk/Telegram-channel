...
export async function downloadTelegramFile(fileId: string): Promise<FileType>{
  ...
  try {
    ...
    return {
      ...
      mimeType: lookup(data.result.file_path) || "unknown", // TODO: всю функцию нормально типизировать и облепить проверками
