...
async function downloadTelegramFile(token: string, fileId: string): Promise<Blob> {
  try {
    // Step 1: Get the file_path using getFile endpoint
    ...
    // Step 2: Download the file using the file_path
